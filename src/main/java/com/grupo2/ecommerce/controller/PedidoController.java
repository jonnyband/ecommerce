...
public class PedidoController {
	...
	public ResponseEntity<PedidoResponseDTO> cadastrar(@RequestBody PedidoRequestDTO pedidoDTO) {
		...
		String mensagem = "<body style=\"max-width: 768px; margin: auto; padding: 0rem 3rem; font-family: Arial, Helvetica, sans-serif\">\r\n"
				...
				+ "        <p style=\"font-size: 0.875rem;\">Comprador:" + pedidoResponseDTO.getCliente().getNomeCompleto() + "</p>\r\n"
				+ "        <p style=\"font-size: 0.875rem;\">Pedido n°:" + pedidoResponseDTO.getId() + "</p>\r\n"
				+ "        <p style=\"font-size: 0.875rem;\">Realizado em: " + pedidoResponseDTO.getDataPedido() + " - Horário de Brasília.</p>\r\n"
