...
public class PedidoController {
	...
	public ResponseEntity<PedidoResponseDTO> cadastrar(@RequestBody PedidoRequestDTO pedidoDTO) {
		...
		String mensagem = "<body style=\"max-width: 768px; margin: auto; padding: 0rem 3rem; font-family: Arial, Helvetica, sans-serif\">\r\n"
				+ "    <h1 style=\"margin-top:4rem; font-size: 1.85rem;\">Olá, <span style=\"background-color: rgb(255, 228, 139); padding: 4px 4px; border-radius: 6px\">@USUARIO</span>!</h1>\r\n"
				+ "    <p style=\"font-size: 0.875rem;\">Agradecemos por comprar na <a href=\"#\" style=\"color: blue;\">@NOMEEMPRESA</a>. Seu pedido foi recebido e será processado após a confirmação do pagamento. Caso o pagamento não seja confirmado dentro do período de três dias, seu pedido será automaticamente cancelado.</p>\r\n"
				...
				+ "        <p style=\"font-size: 0.875rem;\">Comprador: @NOMECOMPLETO</p>\r\n"
				+ "        <p style=\"font-size: 0.875rem;\">Pedido n°: @IDDOPEDIDO</p>\r\n"
				+ "        <p style=\"font-size: 0.875rem;\">Realizado em: @DATADECADASTRODOPEDIDO - Horário de Brasília.</p>\r\n"
				+ "        <p style=\"font-size: 0.875rem;\"> <strong style=\"font-size: 1.25rem;\">Total do pedido:</strong> R$ @VALORTOTAL</p>\r\n"
				+ "        \r\n"
				...
				+ "            <P style=\"display: none;\">@CEP, @CIDADE - @UF. @BAIRRO, @NUMERO, @COMPLEMENTO .</P>\r\n"
				+ "            <P style=\"font-size: 0.875rem;\">25725271, Petrópolis - RJ. Araras, 7225. Próximo ao mercado. </P>\r\n"
				+ "        </div>\r\n"
				+ "\r\n"
				+ "    </div>\r\n"
				+ "</body>";
		...
		emailService.enviar(
				new MensagemEmail("Confirmação do pedido n°" +  pedidoDTO.getId(),
										mensagem,
									"jefferson.souza.correa@gmail.com")
				);
